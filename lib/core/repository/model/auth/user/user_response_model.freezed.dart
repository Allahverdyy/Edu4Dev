...
class _$UserResponseModelImpl implements _UserResponseModel {
  ...
  @override
  String toString() {
    return 'UserResponseModel(name: $name, surname: $surname, address: $address, phoneNumber: $phoneNumber, email: $email)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, surname, address, phoneNumber, email);
